namespace super_toolbox
{
    public static class ExtractorRegistry
    {
        public static readonly Dictionary<string, (string category, string description)> DefaultCategories = new Dictionary<string, (string, string)>
        {
            ...
            { "wav2at3", ("音频", "wav转换到at3的音频转换器,VGAudio不支持此格式,使用索尼官方工具实现转换,仅支持atrac3plus") },

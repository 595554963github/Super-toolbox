...
namespace super_toolbox
{
    public partial class SuperToolbox : Form
    {
        ...
        private readonly Dictionary<string, (string category, string description)> defaultCategories = new Dictionary<string, (string, string)>
        {
            ...
            { "东方天空竞技场 - GPK - gpk", ("其他档案", "东方天空竞技场：幻想乡空战姬的专用解包器") },
            ...
            { "断罪的玛利亚 - dat", ("其他档案", "ps3游戏断罪的玛利亚专用提取器，可解包data.dat文件，提取其中的视频、音频和图片等多种资源") },
            ...
            { "零：濡鸦之巫女 - fmsg", ("其他档案", "零濡鸦之巫女的fmsg转换器，可将fmsg文件转换为txt文本") },
            { "零：濡鸦之巫女 - kscl", ("图片", "零濡鸦之巫女的kscl转换器，能将kscl文件转换为dds图片") },
            ...
            { "女神异闻录5对决：幽灵先锋 - bin", ("其他档案", "女神异闻录5对决：幽灵先锋的专用wmv提取器，能从movie文件夹的bin文件中提取上百个wmv视频") },
            ...
            { "光荣特库摩 - gz/exlilr", ("其他档案", "光荣特库摩的gz和elixir文件提取器，适用于蓝色反射：帝、幻舞少女之剑、无夜之国等游戏") },
            { "光荣特库摩 - ebm", ("其他档案", "光荣特库摩的ebm文件提取器，适配蓝色反射：帝、幻舞少女之剑、无夜之国等游戏") },
            { "光荣特库摩 - g1t", ("图片", "光荣特库摩的g1t文件提取器，可提取出dds图片，适用于fate系列、无夜之国2等游戏") },
            { "光荣特库摩 - gmpk", ("其他档案", "光荣特库摩的gmpk文件提取器，适用于零系列的濡鸦之巫女等游戏，能提取gmpk文件中的各类资源") },
            { "光荣特库摩 - pak", ("其他档案", "光荣特库摩的pak文件提取器，适用于蓝色反射：帝、幻舞少女之剑、苏菲的炼金工房2等游戏") },
            ...
            { "5pb - LNK4 archives - dat", ("其他档案", "5pb的LNK4文件头的dat解包工具，可解xbox360游戏11只眼：交错的视线等采用该格式的文件") },

...
{
    public class Mio0Standard_Compressor : BaseExtractor
    {
                ...
                await Task.Run(() =>
                {
                    ...
                    foreach (var filePath in filesToCompress)
                    {
                        ...
                        try
                        {
                            ...
                            byte[] compressedData = CompressWithMIO0(fileData, _compressionLevel);
        ...
        private byte[] CompressWithMIO0(byte[] inputData, CompressionLevel level)
        {
            using MemoryStream outputStream = new MemoryStream();

            MIO0 compressor = new MIO0();
            compressor.LookAhead = false;
            compressor.FormatByteOrder = AuroraLib.Core.Endian.Big;

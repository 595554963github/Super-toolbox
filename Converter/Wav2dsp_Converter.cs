...
{
    public class Wav2dsp_Converter : BaseExtractor
    {
                ...
                foreach (var wavFilePath in wavFiles)
                {
                    ...
                    try
                    {
                        ...
                        bool conversionSuccess = await Task.Run(() =>
                            ConvertWavToDsp(wavFilePath, dspFile, cancellationToken));
        ...
        private bool ConvertWavToDsp(string wavFilePath, string dspFilePath, CancellationToken cancellationToken)
        {
            try
            {

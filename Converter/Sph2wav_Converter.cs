...
{
    public class Sph2wav_Converter : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            var files = Directory.GetFiles(directoryPath, "*.sph", SearchOption.AllDirectories)
                .Concat(Directory.GetFiles(directoryPath, "*.nist", SearchOption.AllDirectories))

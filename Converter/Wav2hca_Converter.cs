...
{
    public class Wav2hca_Converter : BaseExtractor
    {
                ...
                foreach (var wavFilePath in wavFiles)
                {
                    ...
                    try
                    {
                        ...
                        bool conversionSuccess = await Task.Run(() =>
                            ConvertWavToHca(wavFilePath, hcaFile, cancellationToken));
        ...
        private bool ConvertWavToHca(string wavFilePath, string hcaFilePath, CancellationToken cancellationToken)
        {
            try
            {

...
{
    public class Raw2wav_Converter : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            var files = Directory.GetFiles(directoryPath, "*.raw", SearchOption.AllDirectories)
            ...
            foreach (var filePath in files)
            {
                ...
                try
                {
                    ...
                    bool success = await ConvertWithCodec(filePath, wavFilePath, cancellationToken, true);

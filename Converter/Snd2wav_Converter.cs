...
{
    public class Snd2wav_Converter : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            var files = Directory.GetFiles(directoryPath, "*.snd", SearchOption.AllDirectories)
                .Concat(Directory.GetFiles(directoryPath, "*.au", SearchOption.AllDirectories))

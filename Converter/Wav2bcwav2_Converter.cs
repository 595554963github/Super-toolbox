...
namespace super_toolbox
{
    public class Wav2bcwav2_Converter : BaseExtractor
    {
        ...
        private const uint CWAV_ENCODING_PCM8 = 0;
        ...
        private bool ConvertWavToBcwav(string wavFilePath, string bcwavFilePath, CancellationToken cancellationToken)
        {
            try
            {
                ...
                cwav.dataSize = (uint)(sampleCount * cwav.channels * 1);
                ...
                for (int ch = 0; ch < channelCount; ch++)
                {
                    ...
                    for (int i = 0; i < sampleCount; i++)
                    {
                        ...
                        cwav.data[dstIdx] = (byte)((sample >> 8) & 0xFF);
                    }
                }
        ...
        private byte[] BuildBcwav(CWAV cwav)
        {
            ...
            offset += WriteValue(output, offset, (byte)CWAV_ENCODING_PCM8);

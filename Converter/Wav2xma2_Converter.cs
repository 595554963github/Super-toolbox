...
{
    public class Wav2xma2_Converter : BaseExtractor
    {
        ...
        static Wav2xma2_Converter()
        {
            _tempExePath = LoadEmbeddedExe("embedded.xmaencode.exe", "xmaencode.exe");
        }

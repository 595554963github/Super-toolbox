...
{
    public class Sf2wav_Converter : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            var files = Directory.GetFiles(directoryPath, "*.sf", SearchOption.AllDirectories)
                .Concat(Directory.GetFiles(directoryPath, "*.ircam", SearchOption.AllDirectories))

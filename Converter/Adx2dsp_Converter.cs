...
{
    public class Adx2dsp_Converter : BaseExtractor
    {
                ...
                foreach (var adxFilePath in adxFiles)
                {
                    ...
                    try
                    {
                        ...
                        bool conversionSuccess = await Task.Run(() =>
                            ConvertAdxToDsp(adxFilePath, dspFile, cancellationToken));
        ...
        private bool ConvertAdxToDsp(string adxFilePath, string dspFilePath, CancellationToken cancellationToken)
        {
            try
            {
